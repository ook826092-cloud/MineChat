...
import cn.mine.minestars.data.datastore.DisplaySetting
import cn.mine.minestars.ui.components.nav.BackButton
import cn.mine.minestars.ui.components.ui.CardGroup
import cn.mine.minestars.ui.hooks.rememberSharedPreferenceBoolean
        ...
        LazyColumn(
            ...
            item {
                ...
                CardGroup(
                    ...
                    // recordHttpResponseBody: between volume key scroll and TTS
                    item(
                        headlineContent = { Text("记录HTTP响应体") },
                        supportingContent = { Text("在日志中记录HTTP响应体，用于抓包分析，默认关闭") },
                        trailingContent = {
                            Switch(
                                checked = settings.recordHttpResponseBody,
                                onCheckedChange = { vm.updateSettings(settings.copy(recordHttpResponseBody = it)) }
                            )
                        },
                    )
                }
