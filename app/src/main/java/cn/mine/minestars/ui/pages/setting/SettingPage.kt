...
import cn.mine.minestars.data.db.isNotConfigured
...
import cn.mine.minestars.ui.components.ui.Select
import cn.mine.minestars.ui.components.ui.icons.DiscordIcon
import cn.mine.minestars.ui.components.ui.icons.TencentQQIcon
import cn.mine.minestars.ui.context.LocalNavController
import cn.mine.minestars.ui.context.Navigator
import cn.mine.minestars.ui.hooks.rememberColorMode
import cn.mine.minestars.ui.theme.ColorMode
import cn.mine.minestars.ui.theme.CustomColors
import cn.mine.minestars.utils.joinQQGroup
import cn.mine.minestars.utils.openUrl
        ...
        LazyColumn(
            ...
            item("generalSettings") {
                ...
                CardGroup(
                    ...
                    item(
                        onClick = { navController.navigate(Screen.SettingUserPersona) },
                        leadingContent = { Icon(HugeIcons.UserCircle, null) },
                        supportingContent = { Text(stringResource(R.string.setting_page_user_persona_desc)) },
                        headlineContent = { Text(stringResource(R.string.setting_page_user_persona)) },
                    )
                    item(
            ...
            item("tavernSettings") {
                CardGroup(
                    ...
                    item(
                        onClick = { navController.navigate(Screen.Presets) },
                        leadingContent = { Icon(painterResource(R.drawable.edit_square_24), null) },
                        supportingContent = { Text("管理提示词预设") },
                        headlineContent = { Text("预设") },
                    )
                    item(
                        onClick = { navController.navigate(Screen.WorldBooks) },
                        leadingContent = { Icon(HugeIcons.Book03, null) },
                        supportingContent = { Text("管理世界书条目") },
                        headlineContent = { Text("世界书") },
                    )
                    item(
                        onClick = { navController.navigate(Screen.RegexScripts) },
                        leadingContent = { Icon(painterResource(R.drawable.eco_24), null) },
                        supportingContent = { Text("管理正则表达式") },
                        headlineContent = { Text("正则") },
                    )
                }
            }
            ...
            item("modelServices") {
                CardGroup(
                    ...
                    item(
                        ...
                        leadingContent = { Icon(painterResource(R.drawable.deployed_code_24), null) },
                    ...
                    item(
                        onClick = { navController.navigate(Screen.SettingKnowledgeBase) },
                        leadingContent = { Icon(HugeIcons.Database01, null) },
                        supportingContent = { Text("管理知识库和向量检索") },
