...
fun McpPicker(
    ...
    val assistantMcpServerDao: AssistantMcpServerDAO = koinInject()
                    ...
                    Switch(
                        ...
                        onCheckedChange = {
                            if (it) {
                                ...
                                scope.launch {
                                    assistantMcpServerDao.insert(
                                        AssistantMcpServerEntity(assistant.id.toString(), server.id.toString())
                                    )
                                }
                            } else {
                                val newServers = assistant.mcpServers.toMutableSet()
                                ...
                                scope.launch {
                                    assistantMcpServerDao.delete(assistant.id.toString(), server.id.toString())
                                }
                            }
                        }
                    )
