...
import cn.mine.minestars.ui.components.ai.ModelAbilityTag
import cn.mine.minestars.ui.components.ai.ModelModalityTag
import cn.mine.minestars.ui.components.ai.ModelSelector
import cn.mine.minestars.ui.components.ai.ModelTypeTag
import cn.mine.minestars.ui.components.ai.ProviderBalanceText
import cn.mine.minestars.ui.components.nav.BackButton
import cn.mine.minestars.ui.components.ui.AutoAIIcon
import cn.mine.minestars.ui.components.ui.ShareSheet
import cn.mine.minestars.ui.components.ui.Tag
import cn.mine.minestars.ui.components.ui.TagType
import cn.mine.minestars.ui.components.ui.rememberShareSheetState
...
import cn.mine.minestars.ui.pages.assistant.detail.CustomBodies
import cn.mine.minestars.ui.pages.assistant.detail.CustomHeaders
import cn.mine.minestars.ui.pages.setting.components.ProviderConfigure
import cn.mine.minestars.ui.pages.setting.components.ProviderConnectionTester
import cn.mine.minestars.ui.pages.setting.components.SettingProviderBalanceOption
import cn.mine.minestars.ui.pages.setting.components.isUsingDefaultBaseUrl
import cn.mine.minestars.ui.pages.setting.components.resetBaseUrlToDefault
...
fun SettingProviderDetailPage(id: Uuid, vm: SettingVM = koinViewModel()) {
    ...
    val provider = providers.find { it.id == id } ?: return
    ...
    val onEdit: (ProviderSetting) -> Unit = { newProvider ->
        scope.launch {
            val entity = newProvider.toEntity(
                type = newProvider::class.simpleName ?: "Unknown",
                displayOrder = providers.indexOf(provider).coerceAtLeast(0),
                builtIn = newProvider.builtIn
            )
    ...
    val onDelete = {
        scope.launch {
            providerDAO.deleteById(provider.id.toString())
        }
        ...
        OutlinedCard {
            Row(
                ...
                IconButton(
                    ...
                    Icon(HugeIcons.Settings03, "Edit")
                }
            }
        }
    }
                ...
                Column(
                    ...
                    Row(
                        ...
                        IconButton(
                            ...
                            Icon(HugeIcons.Settings03, contentDescription = "Edit override")
                        }
                        IconButton(
                            onClick = {
