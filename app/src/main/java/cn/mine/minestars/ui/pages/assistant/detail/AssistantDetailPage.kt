        ...
        LazyColumn(
            ...
            item {
                CardGroup(
                    ...
                    item(
                        onClick = { navController.navigate(Screen.AssistantWorldBookDetail(id)) },
                        leadingContent = { Icon(HugeIcons.BookOpen01, null) },
                        supportingContent = { Text(stringResource(R.string.assistant_detail_world_book_desc)) },
                        headlineContent = { Text(stringResource(R.string.assistant_detail_world_book)) },
                        trailingContent = { Icon(HugeIcons.ArrowRight01, null) },
                    )
                    item(
                        onClick = { navController.navigate(Screen.AssistantRegexScriptList(id)) },
                        leadingContent = { Icon(HugeIcons.FileScript, null) },
                        supportingContent = { Text(stringResource(R.string.assistant_detail_char_regex_desc)) },
                        headlineContent = { Text(stringResource(R.string.assistant_detail_char_regex)) },
                        trailingContent = { Icon(HugeIcons.ArrowRight01, null) },
                    )
                    item(
                        onClick = { navController.navigate(Screen.AssistantTavernBindings(id)) },
                        leadingContent = { Icon(HugeIcons.Link01, null) },
                        supportingContent = { Text(stringResource(R.string.assistant_detail_tavern_binding_desc)) },
                        headlineContent = { Text(stringResource(R.string.assistant_detail_tavern_binding)) },
                        trailingContent = { Icon(HugeIcons.ArrowRight01, null) },
                    )
                    item(
                    ...
                    item(
                        onClick = { navController.navigate(Screen.AssistantWorkspace(id)) },
                        ...
                        headlineContent = { Text(stringResource(R.string.assistant_detail_workspace)) },
                        trailingContent = { Icon(HugeIcons.ArrowRight01, null) },
                    )
                }
            }
