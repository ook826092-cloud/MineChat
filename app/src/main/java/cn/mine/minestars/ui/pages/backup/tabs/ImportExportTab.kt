package cn.mine.minestars.ui.pages.backup.tabs
...
import cn.mine.minestars.ui.components.ui.StickyHeader
                    ...
                    onClick = if (!isExporting) {
                        {
                            ...
                            createDocumentLauncher.launch("minechat_backup_$timestamp.zip")
                        }
                    } else null,
