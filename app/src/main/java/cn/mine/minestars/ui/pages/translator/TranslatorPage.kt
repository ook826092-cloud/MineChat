package cn.mine.minestars.ui.pages.translator
...
import cn.mine.minestars.utils.getText
...
fun TranslatorPage(vm: TranslatorVM = koinViewModel()) {
    ...
    val providers by providerDAO.getAllFlow()
    ...
    val translateModelId by modelSelectionDao.getFlow()
        .map { it?.translateModelId?.let { runCatching { Uuid.parse(it) }.getOrNull() } }
                    ...
                    ModelSelector(
                        ...
                        onSelect = {
                            scope.launch {
                                ...
                                modelSelectionDao.set(current.copy(translateModelId = it.id.toString()))
                            }
                        },
                        providers = providers,
                        type = ModelType.CHAT,
