...
import cn.mine.ai.provider.ClaudePromptCacheTtl
...
private fun ProviderConfigureOpenAI(
    ...
    Row(
        ...
        Text(stringResource(id = R.string.setting_provider_page_enable))
        Switch(
    ...
    Row(
        ...
        Text(stringResource(id = R.string.setting_provider_page_response_api))
        Switch(
    ...
    Row(
        ...
        Text(stringResource(id = R.string.setting_provider_page_include_history_reasoning))
        Switch(
...
private fun ProviderConfigureGoogle(
    ...
    Row(
        ...
        Text(stringResource(id = R.string.setting_provider_page_vertex_ai))
        Switch(
    ...
    if (provider.vertexAI) {
        Row(
            ...
            Text(stringResource(id = R.string.setting_provider_page_use_service_account))
            Switch(
