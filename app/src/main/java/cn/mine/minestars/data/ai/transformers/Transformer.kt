...
class TransformerContext(
    ...
    val tavernRegexScripts: List<TavernRegexScript> = emptyList(),
    val tavernMacroContext: TavernMacroContext? = null,
)
...
suspend fun List<UIMessage>.transforms(
    ...
    tavernRegexScripts: List<TavernRegexScript> = emptyList(),
    ...
    val ctx = TransformerContext(
        ...
        tavernRegexScripts = tavernRegexScripts,
        tavernMacroContext = tavernMacroContext,
    )
